...
date: 2022-10-22
excerpt: "MatchCLIP: viewing object-relation classification as a matching problem for panoptic scene graph classification. Achieved 34.60% mean recall@3."
---
...
As a result, I propose a network called MatchCLIP inspired from GroupViT and modify it to adapt the PSG Classification task. The proposed method is easy to implement and does not need much modification from the naive ViT. The main contributions in this project include:
...
- Conducted detailed ablation experiments to find the optimal training settings and hyperparameters. Achieve 34.60% mean recall@3 on the PSG classification competition leaderboard.
